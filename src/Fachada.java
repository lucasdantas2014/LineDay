...
public class Fachada
{
  ...
  public void editarUsuario(Usuario user) throws SQLException
  {
    ...
    while (continuarEdicao) {
      ...
      System.out.println("0 - terminar ediÃƒÂ§ÃƒÂ£o");
  ...
  public void cadastrarAtividade(Usuario user)
  {
    ...
    while (maisTags)
    {
      ...
      if (opTag == 1) {
        System.out.println("Digite o nÃƒÂºmero referente a tag que deseja acrescentar a essa atividade:");
  ...
  public void excluirAtividadePorIndice(Usuario user) {
    ...
    System.out.println("2 - SÃ³ excluir");
